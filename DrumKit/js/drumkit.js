(() => {
  ...
  function playSound(event) {
    ...
    // it contains all kinds of information about the event -> the target, what called it, where it happened in the app etc

    // find the audio element that matches the keybaord key pressed, and make it play
    ...
    if (!audio) { return } // a return is a way to stop function execution -> basically
                          // means stop code here

    audio.currentTime = 0;
    audio.play();

// find the div that matches the keyboard key
